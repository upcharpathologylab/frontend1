...
import promiseImage from "../../assets/about-promise.webp";
    ...
    <section className="bg-white py-7">
      <div className="container-page">
        <div className="grid overflow-hidden rounded-lg border border-blue-100 bg-white shadow-card lg:grid-cols-[0.9fr_1.1fr]">
          <img src={promiseImage} alt="Healthcare partnership handshake" className="h-full min-h-[260px] w-full object-cover" width="470" height="222" loading="lazy" decoding="async" />
