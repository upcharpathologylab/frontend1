...
export const adminManagementConfigs = {
  ...
  couponsOffers: {
    ...
    formFields: [
      ...
      { key: "applicableOn", label: "Applicable Tests / Packages", type: "select", options: ["All", "Tests", "Packages", "Specific Items"], defaultValue: "All" },
      { key: "applicableItems", label: "Applicable Item Names", type: "textarea", showWhen: { key: "applicableOn", value: "Specific Items" } },
